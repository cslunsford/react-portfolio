            ...
            <Card className='h-100 align-items-center'>
                ...
                <Card.Body className='d-flex flex-column justify-content-between'>
                    ...
                    <div className='d-flex justify-content-around mt-auto'>
                        <Button size='sm' href={deployedLink} target='_blank' rel='noopener noreferrer'>
                            Deployed App
                        </Button>
                        <Button size='sm' href={repoLink} target='_blank' rel='noopener noreferrer' className='ml-2'>
                            GitHub Repository
                        </Button>
                    </div>
                </Card.Body>
